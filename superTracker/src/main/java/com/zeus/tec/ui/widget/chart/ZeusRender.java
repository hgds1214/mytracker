package com.zeus.tec.ui.widget.chart;
...
public class ZeusRender extends LineRadarRenderer {
    ...
    public ZeusRender(LineDataProvider chart, ChartAnimator animator,
    ...
    protected void drawHorizontalBezier(ILineDataSet dataSet) {
        ...
        // add by wrx
        mXBounds.min = 0;
        mXBounds.max = dataSet.getEntryCount() - 1;
